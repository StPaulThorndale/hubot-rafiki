...
hubot-rafiki is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start hubot-rafiki locally by running:
...
Then you can interact with hubot-rafiki by typing `hubot-rafiki help`.

    hubot-rafiki> hubot-rafiki help
    hubot-rafiki animate me <query> - The same thing as `image me`, except adds [snip]
    hubot-rafiki help - Displays all of the help commands that hubot-rafiki knows about.
    ...
